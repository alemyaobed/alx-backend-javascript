...
// It should accept a map as an argument. The map it accepts for
// argument is similar to the map you create in the previous task.
...
export default function updateUniqueItems(map) {
  if (map instanceof Map) {
    // Create a new Map to store updated values (avoids modifying original)
    // const updatedMap = new Map(map);

    // Update quantities for items with quantity 1
